...
<section class="container mx-auto p-4 mt-4">
    <div class="rounded-lg shadow-md bg-white p-3">
        ...
        <div class="flex justify-between items-center">
            ...
            <?php if (Framework\Authorization::isAuthorized($listing->user_id)) : ?>
        ...
        <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4">
                <li class="mb-2"><strong>Salary:</strong> <?= salaryFormatter($listing->salary) ?></li>
                <li class="mb-2">
                    <strong>Location:</strong> <?= $listing->state ?>
                    <span class="text-xs bg-blue-500 text-white rounded-full px-2 py-1 ml-2"><?= $listing->city ?></span>
                </li>
                <li class="mb-2">
